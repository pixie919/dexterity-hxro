	...
	return (
		<div className="flex flex-col justify-center items-center border border-white rounded-lg p-4 mt-4">
			...
			<div className="w-full flex flex-col items-center">
				<label htmlFor="priceInput" className="text-xl font-semibold mb-1">
					Price
				</label>
				<input
					id="priceInput"
			...
			<div className="w-full flex flex-col items-center">
				<label htmlFor="sizeInput" className="text-xl font-semibold mb-1">
					Size
				</label>
				<input
					id="sizeInput"
			...
			<div className="flex items-center space-x-4">
				<div
					className={`p-2 pr-8 pl-8 ${
						orderType === "Long" ? "bg-[#80ff7d]" : "bg-gray-200"
					}`}
				>
					<label
				...
				<div
					className={`p-2 pr-8 pl-8 ${
						orderType === "Short" ? "bg-[#ff80f2]" : "bg-gray-200"
					}`}
				>
					<label
						className="text-xl font-semibold text-white"
			...
			<Button
				...
				className={
					isFormValid
						? "mt-4 bg-gradient-to-br from-[#80ff7d] to-[#80ff7d] hover:from-white hover:to-purple-300 text-black"
						: ""
				}
